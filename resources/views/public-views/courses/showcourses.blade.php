...
@section('content')
    ...
    <section class="g-bg-secondary">
      <div class="container g-py-100">
        ...
        <!-- Online Course -->
        @foreach($courses as $course_category_id => $category_courses)
        <div class="text-center g-my-30">
          <h2 class="h3 g-color-black text-uppercase mb-2">
            {{\App\CourseCategory::where('id', $course_category_id)->first()->course_category_name}}
          </h2>
          <div class="u-divider u-divider-solid u-divider-center g-brd-pink g-my-40">
           <i class="u-divider__icon g-bg-pink g-color-white rounded-circle">{{ $category_courses->count() }}</i>
         </div>
        </div>
