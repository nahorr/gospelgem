                ...
                <article class="g-mb-100">
                  <div class="g-mb-30">
                    ...
                    <h2 class="h4 g-color-black g-font-weight-600 mb-3">
                      ...
                      <a href="{{ url()->previous() }}" class="pull-right"><button type="button" class="btn btn-primary">Back to Forum</button></a>
                    </h2>
                                ...
                                <img class="d-flex g-width-50 g-height-50 rounded-circle g-mt-3 g-mr-20" src="{{asset('uploads/avatars/'.$reply->user->avatar)}}" alt="Image Description">
                                  <div class="media-body u-shadow-v22 g-bg-danger g-bg-primary--hover g-pa-30" style="box-shadow: 0 2px 5px #999;">
                                    <div class="g-mb-15">
                                      <h5 class="d-flex justify-content-between align-items-center h5 g-color-gray-dark-v1 mb-0">
                                        <span class="d-block g-mr-10">
                                          <a class="u-tags-v1 g-font-size-12 g-brd-around g-brd-gray-light-v4 g-bg-primary--hover g-brd-primary--hover g-color-black-opacity-0_8 g-color-white--hover rounded g-py-6 g-px-15" href="#!">{{$reply->user->name}} replied to your comment</a> 
                                        </span>
