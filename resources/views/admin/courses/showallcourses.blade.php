                       ...
                       <tbody>
                        @foreach($courses as $key => $course)
                         <tr>
                           ...
                           <td>
                            <a href="{{url('admin/courses/showregistration/'. $course->id)}}" class="btn btn-md u-btn-orange" >{{ $course_registrations->where('course_id',$course->id)->count() }} Registrations</a>
                           </td>
