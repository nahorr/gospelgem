            ...
            <div class="g-pa-20">
                 ...
                 <header class="g-mb-20">
                   <h2 class="g-font-weight-400 g-font-size-16 g-color-black mb-0">
                    <strong>Picture Category Table</strong>
                    <button type="button" class="btn btn-md u-btn-darkpurple g-mr-10 g-mb-15 pull-right" id="addPicCategory">New Picture Category</button>
                 </h2>
                 </header>
                 <!-- Add Category -->
                 <form class="g-brd-around g-brd-gray-light-v4 g-pa-30 g-mb-30" method="post" action="{{ url('/admin/storeNewPicCategory') }}" id="ajaxFormNewPicCategory" style="display: none;">
                   {{ csrf_field() }}

                   <div class="form-group g-mb-25 col-md-3">
                     <label for="post_title">Picture Category Name</label>
                   ...
                   <div class="form-group g-mb-25 col-md-6">
                    <label for="exampleTextarea">Please description this picture category</label>
                   ...
                   <div class="form-group g-mb-25 col-md-6">
                    <button type="submit" class="btn btn-success" id="ajaxSubmitaddPicCategory">Add Picture Category</button>
                    <button type="button" class="btn btn-danger" id="ajaxCloseAddPicCategory">Close</button>
                  </div>
                 ...
                 <script>
                    jQuery(document).ready(function(){
                      ...
                      $("#ajaxFormNewPicCategory").addClass("noDisplay");
                      
                      $("#ajaxSubmitaddPicCategory").click(function(){
        
                         $("#ajaxFormNewPicCategory").hide(1000);
                        
                      });

                      $("#addPicCategory").click(function(){
                         $("#ajaxFormNewPicCategory").show(1000);
                      });

                      $("#ajaxCloseAddPicCategory").click(function(){
                         $("#ajaxFormNewPicCategory").hide(1000);
                      });
                   });

                        $(function () {
                            $('#ajaxFormNewPicCategory').submit(function (e) {
                     ...
                     <thead>
                       <tr>
                        <th class="g-px-30">
                         ...
                         <th class="g-px-30">
                           <div class="media">
                             <div class="d-flex align-self-center">Picture Category Name</div></div>
                         </th>
                         <th class="g-px-30">
                           <div class="media">
                             <div class="d-flex align-self-center">Picture Category Description</div></div>
                         </th>
                         <th class="g-px-30">
                           <div class="media">
